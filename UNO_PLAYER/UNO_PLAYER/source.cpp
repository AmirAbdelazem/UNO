...
int main()
{
    ...
    UNO OBJ;
    cout << "\n\n   one player is trivial as it will play only until win the game\n";
    cout << "but to get time analysis of the code after entering the number of players\n\n ";
